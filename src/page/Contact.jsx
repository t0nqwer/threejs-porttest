...
const Contact = () => {
  ...
  return (
    <div className="z-20 flex items-end w-full h-screen py-10 overflow-hidden select-none bg-opacity-80 xl:backdrop-blur-md md:backdrop-blur bg-neutral-900 backdrop-blur ">
